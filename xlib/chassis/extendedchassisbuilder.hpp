...
namespace xlib {
    ...
    class ExtendedChassisBuilder {
        ...
        ChassisScales scales {{1, 1}, imev5BlueTPR /*imev5GreenTPR*/};
        float trackWidth;

        std::shared_ptr<RotationSensor> rotationsensor;
    ...
    public:
        ...
        ExtendedChassisBuilder& withSensors(const RotationSensor& irotation ,
                                           const IMU& inertial);
